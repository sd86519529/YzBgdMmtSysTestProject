...
class MachRefundDispatch(unittest.TestCase):
    """
    退款记账测试用例: <br>
    1>>子商户不承担手续费的流程组合 test_flow_not_change_refund<br>
    """
    ...
    def test_flow_not_change_refund(self, flow_not_change_refund):
        ...
        self.after_treatment_data = Handle.machaccnt_pay_dispatch_handle(flow_not_change_refund)
    ...
    def tearDown(self):
        ClearingKeepingAccounts.machaccnt_refund_dispatch_clear(self.amt_info_after, self.mach_pay_up_obj)
        log.info('******************************** -- 测试结束 -- ********************************************')
        log.info('\r\n\r\n\r\n\r\n')
