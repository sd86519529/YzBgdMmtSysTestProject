...
@app.route('/do/s/<statement>/<rest>/<v1>/<merchant>/<register>', methods=['GET', 'POST'])
def do_store(statement, rest, v1, merchant, register):
    return '{"errorCode":"0002","errorMsg":"测试","nonceStr":"4ba6cdd54aa2426eb5eefc1dc6dcb61a","resultCode":"FAIL"}'
